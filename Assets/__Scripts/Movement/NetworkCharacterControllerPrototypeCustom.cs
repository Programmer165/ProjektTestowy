...
public class NetworkCharacterControllerPrototypeCustom : NetworkTransform
{
    ...
    public float _jumpImpulse = 8.0f;
    public float _acceleration = 10.0f;
    public float _braking = 10.0f;
    public float _maxSpeed = 5.0f;
    public float _runMaxSpeed = 7.2f;
    public float _rotationSpeed = 300.0f;
    public float _viewUpDownRotationSpeed = 300.0f;
    ...
    /// </summary>
    protected override Vector3 DefaultTeleportInterpolationAngularVelocity => new Vector3(0f, 0f, _rotationSpeed);
    ...
    /// <param name="overrideImpulse">Optional field to override the jump impulse. If null, <see cref="_jumpImpulse"/> is used.</param>
    /// </summary>
    public virtual void Jump(bool ignoreGrounded = false, float? overrideImpulse = null)
    {
        ...
        {
            var newVel = Velocity;
            newVel.y += overrideImpulse ?? _jumpImpulse;
            Velocity = newVel;
        }
    }
    ...
    public virtual void Move(Vector3 direction)
    {
        ...
        {
            horizontalVel = Vector3.ClampMagnitude(horizontalVel + direction * _acceleration * deltaTime, _maxSpeed);
        }
    ...
    {
        transform.Rotate(0, rotationY * Runner.DeltaTime * _rotationSpeed, 0);
    }
}